...
#'
#' @param x The sample
#' @param conf.level The value of 1 - alpha for your confidence interval used in getting the p-value
#' @param iter The number of iterations in the bootstrap method
#' @param mu0 The null hypothesis value for mu
#' @param test Which type of test you want to use
#'
#' @return A list of the important statistics used in bootstrapping the p-value.
#' @export
#'
#' @examples
